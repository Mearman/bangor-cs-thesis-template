...
By default the page number sits at the right of the footer and reads ``Page N of M''. To move it into the header, where it takes the place of the section name, set \texttt{headers=chapter}; \texttt{pageofm=false} prints the number alone.
